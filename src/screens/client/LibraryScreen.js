  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.container}>
        <Ionicons name="play-circle" size={48} color={colors.primary} style={{ marginBottom: 16 }} />
        <Text style={styles.title}>Media Library</Text>
        <Text style={styles.sub}>Coming soon — workout videos, PDF guides, and past plans</Text>
      </View>
    </SafeAreaView>
  );
}
